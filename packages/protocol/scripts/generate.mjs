...
const validatorDefinitions = {
  ...
  validateDeterministicMakerCaptureManifestV1: "DeterministicMakerCaptureManifestV1",
  validateTestRunBundleManifestV1: "TestRunBundleManifestV1",
  validateTestRunBundleHandleV1: "TestRunBundleHandleV1",
