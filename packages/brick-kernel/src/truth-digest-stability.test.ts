 ...
 *
 * Measured at catalog builtin.basic-parts/8 with 85 definitions, which admitted
 * the three designs LEGO Builder has no record of at all. A move here is
 ...
 * gained three parts and every part's provenance carries the catalog version.
 */
 ...
 * It was 1061f97d932fb9193eb697bcc6f90f060f48a988a241f16ad03aee9272c03eb3 over
 * the first 82 rows and 92c7dc3d6f7990dc5b6dbbddabf02e557f2ec54927f61d6e16bf7e9530b0db4d
 * over the first 77, and both prefixes still hash to exactly that: every new
 * part was appended, and mesh-assets.test.ts holds those separately.
 */
const PINNED_GEOMETRY_ROSTER_SHA256 =
  "5ea04c448b04800b87087f0c5dcb818d46e805eb51d535c9b40b7894281f4af1";

const PINNED_PART_COUNT = 85;
/** 1_204_568 at builtin.basic-parts/6, 1_298_834 at /7. */
const PINNED_CATALOG_SERIALIZED_LENGTH = 1_358_361;
...
describe("builtin truth digest stability", () => {
  ...
  it("publishes those hashes through the snapshot every document stores", () => {
    ...
    expect(truth.catalog.version).toBe("builtin.basic-parts/8");
