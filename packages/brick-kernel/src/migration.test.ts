...
describe("migrateDocumentTruth", () => {
  ...
  it("carries /13 forward and reports all ten complete additive definitions", () => {
  ...
  it("carries /14 forward and reports the nine complete additive definitions", () => {
  ...
  it("carries /15 forward and reports the eight complete additive definitions", () => {
  ...
  it("carries /16 forward and reports the seven complete additive definitions", () => {
  ...
  it("carries /17 forward and reports the next six complete measured definitions", () => {
  ...
  it("carries /18 forward and reports the next five complete measured definitions", () => {
  ...
  it("carries /19 forward and reports the next four complete measured definitions", () => {
  ...
  it("carries a /6 document forward and names the eighteen parts it gained", () => {
  ...
  it("carries a /7 document forward and names the thirteen parts it gained", () => {
    const document = historicalDocument({
      id: "seven",
      name: "Saved at /7",
