...
describe("builtin.basic-parts/20 migration", () => {
  it("adds only the complete measured 3040 definition when /20 advances to /21", () => {
    ...
    expect(report.toTruthHash).toBe(V21_TRUTH_HASH);
    expect(report.addedCatalogPartIds).toEqual([V21_PART_ID]);
