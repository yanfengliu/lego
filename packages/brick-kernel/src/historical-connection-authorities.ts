...
export const CURRENT_CONNECTION_SEMANTICS_AUTHORITY = deepFreeze({
  ...
  endpointCount: 2340,
  endpointMapDigest: "sha256:a48b5e1c841561586bc96ca189a7bc916d991b76eb1a291f6f24a23defe564a1",
  pairCount: 4,
...
> = deepFreeze({
  ...
  "sha256:e34fcc8ac627f0dcfdb1d779246a723101d765f931830a4c06514d9daff75c26": authority(
    ...
    3,
    THREE_PAIR_DIGEST,
    mergeEndpointDeltas(VALIDATED_STUD_PROFILE_CHANGES_V8, V31_STUD_PROFILE_CHANGES_FROM_V19),
  ),
  "sha256:9c4c32efcaf9bc5f2a251e77188134075f58ca536c6da6148e34b93419d84ad2": authority(
    ...
    3,
    THREE_PAIR_DIGEST,
    mergeEndpointDeltas(VALIDATED_STUD_PROFILE_CHANGES_V8, V31_STUD_PROFILE_CHANGES_FROM_V20),
  ),
  ...
  "sha256:54762419e4779c6c15566052062fcaa432cb45e3a13704b5af1563b4fa94e8eb": authority(
    ...
    4,
    FOUR_PAIR_DIGEST,
    mergeEndpointDeltas(JUMPER_1X2_CENTRE_SEAT_CHANGES, V31_STUD_PROFILE_CHANGES_FROM_V23),
  ),
  "sha256:cf2d67907369f85551055665b6df0f849dd978d2e63330130ec2d2db8f6ccc0b": authority(
    ...
    4,
    FOUR_PAIR_DIGEST,
    mergeEndpointDeltas(V31_STUD_PROFILE_CHANGES_FROM_V23),
  ),
});
