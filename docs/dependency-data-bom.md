...
Status: Gate 0 baseline established 2026-07-10; reconciled with catalog `/29` on 2026-08-28
...
The following paragraph is retained historical `/26` provenance. Its current-tense 37-part, 211-file, 21-fully-measured, and 13-LDCad-route statements describe `/26`, not the current `/29` catalog.
...
```json
{
  ...
  "dataAssets": [
    ...
    },
    {
      ...
      "currentCatalogHistory": "The historical /26 catalog carried thirteen exact LDCad routes. /27 added four exact routes: 99563 via parts/96910.dat; 73230 via p/axlehol4.dat, p/stud2.dat, and parts/73230.dat; 35464 via parts/35464.dat; and 49307 via parts/49307.dat. Historical /28 added exact 3245c via p/stud.dat, parts/3245a.dat, parts/3245c.dat, and parts/s/3245cs01.dat, plus exact 2453b via p/stud.dat and parts/2453b.dat, bringing that historical total to nineteen. /29 adds exact 10201 and 3245b routes, bringing the current total to twenty-one. The 10201 redirect to 2436b remains closure evidence rather than a second public alias, and the checked female one-cap A6x44 declaration in the 3245b route emits exactly one `blindAxleHole` endpoint with its finite span and one admitted mouth side; it does not emit a generic through `axleHole`. The intent below retains route history only through /26. Exact connector measurements add no bare or cross-suffix alias, Builder or printed identity, physical frame, placement, replay, execution, acceptance, or completion authority.",
