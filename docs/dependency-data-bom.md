...
Status: Gate 0 baseline established 2026-07-10; reconciled with catalog `/28` on 2026-08-26
...
The current `builtin.basic-parts/28` catalog has 104 parts: 61 retain parametric render recipes, 16 retain project-authored physical recipes behind render-only source-mesh promotions, and 27 are fully measured. Its 43 official LDraw roots/closures resolve to 228 unique files by 33 named authors: 224 files directly declare CC BY 4.0, while `parts/2453b.dat`, `parts/30503.dat`, `parts/32064a.dat`, and `parts/3245c.dat` each offer `CC-BY-2.0 OR CC-BY-4.0` and the bundle selects CC BY 4.0. Nineteen fully measured definitions use exact LDCad connector routes. Historical `/27` had 102 parts, 41 roots, 224 unique files, 25 fully measured definitions, and 17 exact LDCad routes; it added exact official roots `99563`, `73230`, `35464`, and `49307`. `/28` adds only exact suffixed official roots `parts/3245c.dat` (`sha256:9cc04bca1050e0b16a00c76a432f9cbb769655dc79188a0df3cffa2229dc6615`) and `parts/2453b.dat` (`sha256:3c7caddd91a2467243cf3f3bd0bdd8ee8fa1cbd5435591a6491841ee1ca49b01`); their exact LDCad routes are respectively `p/stud.dat`, `parts/3245a.dat`, `parts/3245c.dat`, `parts/s/3245cs01.dat` and `p/stud.dat`, `parts/2453b.dat`. These catalog facts grant no bare or cross-suffix alias, Builder identity, printed identity, placement frame, placement, replay, execution, acceptance, or completion authority.

The following paragraph is retained historical `/26` provenance. Its current-tense 37-part, 211-file, 21-fully-measured, and 13-LDCad-route statements describe `/26`, not the current `/28` catalog.
...
```json
{
  ...
  "rightsPolicies": {
    ...
    "attribution-required-bundled-geometry": {
      "licenseEvidence": "The exact `!LICENSE`, `Author`, `!LDRAW_ORG` and SHA-256 of every bundled file are read from the pinned official archive and preserved per file in packages/catalog/src/ldraw-bundled-sources-6651557.ts. Of the 228 unique files in the 43 bundled closures, 224 directly declare CC BY 4.0; parts/2453b.dat, parts/30503.dat, parts/32064a.dat, and parts/3245c.dat declare CC BY 2.0 or CC BY 4.0, and the bundle selects the CC BY 4.0 option for all four.",
      ...
      "redistribution": "Allowed under CC BY 4.0 with attribution. Real LDraw geometry is bundled for rendering and palette previews. Runtime validators do not inspect the mesh triangles directly, but exact source-derived visual bounds are catalog truth and validator inputs. Connector truth remains separately authored. All twenty-seven fully measured definitions carry attributed authoring-time collision height fields derived from their official surfaces; the sixteen render-only promotions preserve independently authored collision. Runtime consumes emitted bounded boxes rather than treating mesh triangles as a collision oracle.",
  ...
  "dataAssets": [
    {
      ...
      "intent": "Project-authored dimensions and parametric box, shell, wedge, compound-box, and analytic-plan recipes remain physical authority for 77 of the 104 builtin parts: 61 remain parametric renders, while four moved to exact LDraw render surfaces and visual bounds at builtin.basic-parts/12 and twelve more at /13 while retaining their reviewed project-authored connectors, allowances, and conservative collision recipes. The other twenty-seven parts are fully measured definitions: the historical /26 catalog had 98 parts and twenty-one fully measured definitions through 78329; /27 added exact 99563, 73230, 35464, and 49307; /28 adds only exact suffixed 3245c and 2453b. No LDraw mesh file is copied into this layer; all 43 bundled surfaces are recorded separately under ldraw-bundled-part-geometry."
    },
    {
      ...
      "version": "ldraw-complete-2026-07 archive sha256 6009f2e94204c4d3a63a4c812010b5c90bad8c5acb19b882c859fdac63734eae; 43 roots, 228 unique files, 33 named authors; 224 direct CC BY 4.0 declarations, while parts/2453b.dat, parts/30503.dat, parts/32064a.dat, and parts/3245c.dat are CC BY 2.0 or CC BY 4.0 with the CC BY 4.0 option selected; catalog builtin.basic-parts/28. The intent below retains detailed historical measurements through /26; its 37-root, 211-file, and /26 report-control totals are historical rather than current.",
    ...
    },
    {
      ...
      "source": "Local checksum-pinned LEGO Builder Shell meshes for 43 exact design revisions, current catalog/geometry evidence extending the first-50 registry to 62 exact Builder aliases, the retained 21066 LXFML model and derived LDraw MPD, the exact Builder manifest/cache/audit/native-pack evidence join, and local checksum-pinned official/unofficial LDraw archives used only as an independent surface comparison; the exact roster is executable in apps/web/e2e/real-build-builder-sources.ts and scripts/builder_calibration_sources.py",
      "version": "lego.builder-canonical-calibration/8 over frame evidence protocol builder-anchor-frame-plus-ldraw-surface/4 at builtin.basic-parts/28; model sha256 c0564fd86ede633f6cb18738f999fbb70ee948ba93a55cc8d338b4b5f02b5922; derived LDraw MPD 139649 bytes sha256 096b78037ef1ee15a6dcff90b38f00f09465d0f5a246cb6f5f08fac087dd7bc2; 43 reviewed Builder bundle and Shell canonical SHA-256 pairs; official LDraw archive sha256 6009f2e94204c4d3a63a4c812010b5c90bad8c5acb19b882c859fdac63734eae; unofficial LDraw archive sha256 09ec08007203b66e79b1f857aa4804cbee26e1337e177a7c3a87adc1268e44d4; exact 184-file official LDraw closure manifest sha256 72ca520b68934fdaa384e9bbc961090538f0b4ee1269773675db1adcf3cc7fdd; ignored geometry bundle 1820412 bytes sha256 7e91e1402f2ab609fee6e502336f86ee74fb3a94d970e9b0b75acf07f925a76f; ignored calibration report 54993 bytes sha256 40807a2329f43321c4af683096465de57f41be41299bbd5b7dea8354e28fe8e9; ignored official XML/LDraw world proposal 500895 bytes sha256 7b76ef27bbad99f9014fd6543b0fdb47c1fdcfd789d0d9629e16df54a4889da7; ignored exact frame registry 98383 bytes sha256 16a76321d1cbd8bb1308dff9c58ee61507f67c0139b17aa50a5d8415c789e2f2; ignored three-input occurrence/world reconciliation 408269 bytes sha256 63d5872f92d208755dae34ecab7bad31c23b9b4cdcfb4165bbbc3159d281156e; occurrence commitment sha256 63ab9b3bce415598f3a7b7fa0b407f29502df86f6a761fb541191fef28ca7b84; world commitment sha256 da7932eeaeb115e9db38ac7ef01f9b4142df46fd1d3b2eb0a484e09aafa989fe; ignored structural-return artifact 7292 bytes sha256 cdb563b81f89aa9110cc70cc392f7415616aeb3e534ee907547879f8ec82c03e",
      ...
      "intent": "scripts/extract-builder-shell.py parses the exact captured bytes of one hard-coded checksum-pinned Builder bundle per retained design and emits a local Shell inspection; scripts/generate-builder-calibration.py parses the exact already-hashed local archive bytes under fixed ZIP expansion bounds and writes one ignored local geometry bundle. Before geometry expansion, every traversed LDraw member must match the metadata-only closure's normalized path, SHA-256, Author, !LICENSE, and !LDRAW_ORG values; all 184 are official-library files, 180 declaring CC BY 4.0 and four declaring both CC BY 2.0 and CC BY 4.0 in their own headers, and the unofficial archive may not contribute. scripts/builder_calibration_prefix_contract.py independently binds each retained row to the exact manifest/cache/audit/native-pack evidence and recomputes role-bound anchors: only Builder families 0/1 are recognized top studs and family 15 is a recognized underside clutch, while surface-only fallback refuses any authored non-marker/non-absent top or underside lattice even when its family is unmapped. Revision 87580;P is retained through four exact recognized family-15 underside centres matching its four catalog clutches; 3024;N has no recognized lattice route, 15573;L has three recognized underside cells against two catalog clutches, and 35787;N cannot use surface-only fallback over its authored underside cell. The frames themselves are derived in apps/web/e2e/real-build-builder-calibration.ts from those bytes and reviewed source pins. Each local frame is an exact integer role-bound lattice correspondence or explicit lattice-free surface registration, quotiented only by exact current catalog render/collision/connector/bounds/grid-centre/legal-yaw self-symmetry and, where symmetry cannot explain the residual, settled by the independent LDraw surface with an exact pre-rounding four-times mean margin and a two-LDU selected-frame maximum. The exact first-50 census has 320 official Builder occurrences across 66 revisions: 43 local diagnostic frame rows cover 197 occurrences, 182 yield current upright canonical world transforms, 15 remain exact non-upright diagnostic rows, and 138 are refused by the canonical-upright policy overall. The exact opaque `2453;I` item-6595205 route is consumed only by this diagnostic registry; item 4210690 and suffix aliases remain refused. Ten additional revisions are held out diagnostically with no proved current frame and no asserted executable failure mechanism. Nine checksum-mismatched revisions, 10201;H, 3024;N, 15573;L, and 35787;N have separately executable evidence classes. A separate bounded compiler reconciles the exact retained model XML with its exact derived LDraw MPD and emits only the ignored 320-row world-transform proposal; its 309 proposed rows, eleven explicit identity/frame quarantines, and three half-LDU 4519 origins claim no document legality. The downstream frame compiler binds 62 exact design-revision/catalog/LDraw triples and excludes four unresolved alias classes; the occurrence reconciler requires opaque proposal, frame-registry, and action-preparation tokens, derives all eleven copy relations from the action token, binds complete occurrence provenance, and leaves eleven quarantines null. The structural compiler retains the official step-44 subbuild-completion boundary separately from the unauthenticated attachment interpretation, and every generator verifies reviewed bytes before replacing retained evidence. No Builder bundle, Shell report, model XML, LDraw source text, expanded LDraw geometry, generated geometry bundle, calibration report, frame/reconciliation/structural artifact, world-proposal artifact, or source path is committed, packaged, fetched at runtime, uploaded, or approved for training. This evidence grants no official world placement, Builder source execution, prepared-run, replay, document mutation, acceptance, or completion authority; it does not admit a PartDefinition or independently certify connector truth (C), collision truth (X), or canonical world frame truth (F), and changing a digest or limit is not source authorization.",
    ...
    },
    {
      ...
      "currentCatalogHistory": "The historical /26 catalog carried thirteen exact LDCad routes. /27 added four exact routes: 99563 via parts/96910.dat; 73230 via p/axlehol4.dat, p/stud2.dat, and parts/73230.dat; 35464 via parts/35464.dat; and 49307 via parts/49307.dat. /28 adds exact 3245c via p/stud.dat, parts/3245a.dat, parts/3245c.dat, and parts/s/3245cs01.dat, plus exact 2453b via p/stud.dat and parts/2453b.dat, bringing the current total to nineteen. The intent below retains route history only through /26. Exact connector measurements add no bare or cross-suffix alias, Builder or printed identity, physical frame, placement, replay, execution, acceptance, or completion authority.",
...
- The current 104-part `builtin.basic-parts/28` catalog, connector taxonomy, collision model, and derived Three.js geometry are implemented with versioned provenance; 77 definitions retain project-authored physical recipes and 27 are fully measured, while the render path comprises 61 parametric definitions and 43 exact LDraw roots or closures, including 16 render-only promotions. The historical `/26` catalog contained 98 parts, and `/27` contained 102. Individual geometry recipes carry SHA-256 content hashes and the truth snapshot pins their aggregate interpretation inputs. Synthetic benchmark examples remain an intent record.
- Real LDraw part geometry is bundled under the selected CC BY 4.0 option for 43 parts. Historical `/26` comprised 37 roots, 211 unique files, and 21 fully measured definitions; `/27` added fully measured `99563`, `73230`, `35464`, and `49307`, reaching 41 roots, 224 files, and 25 fully measured definitions; `/28` adds exact suffixed `3245c` and `2453b`, reaching 43 roots, 228 files, and 27 fully measured definitions. File-level attribution covers 224 direct CC BY 4.0 declarations plus `parts/2453b.dat`, `parts/30503.dat`, `parts/32064a.dat`, and `parts/3245c.dat`, whose CC BY 4.0 option is selected from dual declarations, across 33 named authors. All sixteen render-only promotions preserve their reviewed connector, allowance, and conservative collision declarations; a render mesh does not establish physical truth.
