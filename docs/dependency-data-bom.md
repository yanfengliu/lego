...
Status: Gate 0 baseline established 2026-07-10; reconciled with catalog `/31` on 2026-09-24
...
The following paragraph is retained historical `/26` provenance. Its current-tense 37-part, 211-file, 21-fully-measured, and 13-LDCad-route statements describe `/26`, not the current `/31` catalog.
