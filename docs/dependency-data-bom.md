...
Status: Gate 0 baseline established 2026-07-10; reconciled with catalog `/30` on 2026-08-29
...
The current `builtin.basic-parts/30` catalog has 106 parts: 60 retain parametric render recipes, 16 retain project-authored physical recipes behind render-only source-mesh promotions, and 30 are fully measured. Its 46 official LDraw roots/closures resolve to 239 unique files by 34 named authors: 235 files directly declare CC BY 4.0, while `parts/2453b.dat`, `parts/30503.dat`, `parts/32064a.dat`, and `parts/3245c.dat` each offer `CC-BY-2.0 OR CC-BY-4.0` and the bundle selects CC BY 4.0. 22 fully measured definitions use exact LDCad connector routes. Historical `/27` had 102 parts, 41 roots, 224 unique files, 25 fully measured definitions, and 17 exact LDCad routes; historical `/28` added exact suffix-only `3245c` and `2453b`; historical `/29` added exact `10201` and `3245b`. `/30` promotes the existing `builtin:jumper-plate-1x2` identity to exact official root `parts/15573.dat` (`sha256:c6946965875a8275996c4559cd355ea13a20197e96f33585cd750bb1da89b56d`) with its 11-file, 12,907-byte closure at `sha256:c7a8d39b4b45fee945580a3e59f3d2e54dd231667ed24b0186ecc88bee73c2d1`, measured collision, and three LDCad-authored underside seats; its two historical outer endpoint IDs remain and the new centered seat shares one capacity cell with each outer. The exact female one-cap A6 × 44 metadata in the retained `3245b` route remains one fixed `blindAxleHole` with its closed end, open mouth, outward normal, finite 44 LDU span, and `slide=false` preserved. These catalog facts grant no bare or cross-suffix alias, Builder identity, printed identity, placement frame, placement, replay, execution, acceptance, or completion authority.
...
The following paragraph is retained historical `/26` provenance. Its current-tense 37-part, 211-file, 21-fully-measured, and 13-LDCad-route statements describe `/26`, not the current `/30` catalog.
...
The source policy has one separate compiled-binary admission: the repository-authored Windows Poppler job launcher. Only its exact repository path and 15,360 bytes at `sha256:10b825ba6ff6dff1866cb90927798ee9884ef2e3a351388ba31eb2fadff11c8b` are admitted, and only alongside the complete 18,635-byte C# source at `sha256:02841a492c0b1a49afedb27bfc6f0ad7f3e6c0538aad3a4d4c45f3376bf378f2` in the same census population. The C# source still passes the normal text and encoded-literal checks; the binary is not treated as text, and renamed DLLs, changed bytes, missing source, or duplicate source/binary entries are refused. On 2026-09-08, the reviewed candidate source was compiled twice into distinct fresh output directories with the same six compiler/framework pins and flags as `scripts/check-bom-source-policy-launcher-rebuild.mjs`; both DLL byte arrays were identical. The two target compiler invocations used the shipped bounded-child launcher, whose existing PowerShell/Add-Type bootstrap also compiles its helper. No candidate assembly was loaded. The earlier 2026-09-05 reproduction of the 13,312-byte DLL from its 15,376-byte source remains historical evidence. The existing opt-in verifier pins the installed Visual Studio 18 Roslyn compiler and its core assemblies/configuration plus two explicit .NET Framework references, uses `/noconfig /nostdlib+ /target:library /optimize+ /deterministic`, never executes the resulting assembly, and removes only its own temporary directory. Reproduction at the installed production source path remains a separate integration check; the candidate-packet measurement is not substituted for it. This is a trusted-local build reproduction, not a hermetic compiler, OS-integrity proof, or production signing boundary. Ordinary offline `bom:check` validates the exact source/binary pair without requiring that Windows compiler on every platform. The inventory remains 25 data/source records; the earlier 24-record census measurement remains historical.
...
```json
{
  ...
  "dataAssets": [
    {
      "id": "source-reproduced-windows-poppler-launcher",
      "category": "repository-authored-compiled-development-helper",
      "status": "implemented-project-authored",
      "source": "apps/web/e2e/real-build-prefix50-subbuild-return-review-poppler-job-launcher.cs",
      "version": "C# source sha256 02841a492c0b1a49afedb27bfc6f0ad7f3e6c0538aad3a4d4c45f3376bf378f2; 18635 source bytes; 15360 DLL bytes; DLL sha256 10b825ba6ff6dff1866cb90927798ee9884ef2e3a351388ba31eb2fadff11c8b; two byte-identical candidate builds with the existing pinned Roslyn recipe on 2026-09-08; production-path rebuild remains pending",
      "declaredLicense": "MIT",
      "rightsPolicy": "project-mit",
      "allowedRoles": ["private reconstruction tests", "owned Windows child-process cleanup"],
      "intent": "The exact companion DLL is compiled from the complete repository-authored C# source and supplies Windows Job Object process ownership for the local Poppler harness. It is not Poppler, geometry, booklet content, a provider artifact, or a production trust broker. Preserve the project copyright and MIT notice. The compiler and .NET Framework reference assemblies remain separately installed host build inputs and are not bundled in the repository. The exact-pair policy and source-free negative controls live in scripts/check-bom-source-policy-binary.mjs and its test; the opt-in rebuild command retains explicit compiler/reference pins and fails rather than accepting a different output. No training or benchmark-corpus role is granted."
    },
    {
      ...
      "intent": "Project-authored dimensions and parametric box, shell, wedge, compound-box, and analytic-plan recipes remain physical authority for 76 of the 106 builtin parts: 60 remain parametric renders, while four moved to exact LDraw render surfaces and visual bounds at builtin.basic-parts/12 and twelve more at /13 while retaining their reviewed project-authored connectors, allowances, and conservative collision recipes. The other thirty parts are fully measured definitions: the historical /26 catalog had 98 parts and twenty-one fully measured definitions through 78329; /27 added exact 99563, 73230, 35464, and 49307; /28 added only exact suffixed 3245c and 2453b; /29 added exact 10201 and 3245b; /30 promotes existing jumper 15573 to an exact fully measured definition without changing its catalog identity. No LDraw mesh file is copied into this layer; all 46 bundled surfaces are recorded separately under ldraw-bundled-part-geometry."
    },
    {
      ...
      "version": "ldraw-complete-2026-07 archive sha256 6009f2e94204c4d3a63a4c812010b5c90bad8c5acb19b882c859fdac63734eae; 46 roots, 239 unique files, 34 named authors; 235 direct CC BY 4.0 declarations, while parts/2453b.dat, parts/30503.dat, parts/32064a.dat, and parts/3245c.dat are CC BY 2.0 or CC BY 4.0 with the CC BY 4.0 option selected; catalog builtin.basic-parts/30. The intent below retains detailed historical measurements through /26; its 37-root, 211-file, and /26 report-control totals are historical rather than current.",
    ...
    },
    {
      ...
      "currentCatalogHistory": "The historical /26 catalog carried thirteen exact LDCad routes. /27 added four exact routes: 99563 via parts/96910.dat; 73230 via p/axlehol4.dat, p/stud2.dat, and parts/73230.dat; 35464 via parts/35464.dat; and 49307 via parts/49307.dat. Historical /28 added exact 3245c via p/stud.dat, parts/3245a.dat, parts/3245c.dat, and parts/s/3245cs01.dat, plus exact 2453b via p/stud.dat and parts/2453b.dat, bringing that historical total to nineteen. Historical /29 added exact 10201 and 3245b routes, bringing that total to twenty-one. Current /30 adds the exact 15573 route and brings the total to twenty-two; its two historical outer endpoint IDs retain separate adjacent half-capacity cells while the new centered endpoint consumes both. The 10201 redirect to 2436b remains closure evidence rather than a second public alias, and the checked female one-cap A6x44 declaration in the 3245b route emits exactly one `blindAxleHole` endpoint with its finite span and one admitted mouth side; it does not emit a generic through `axleHole`. The intent below retains route history only through /26. Exact connector measurements add no bare or cross-suffix alias, Builder or printed identity, physical frame, placement, replay, execution, acceptance, or completion authority.",
...
- The current 106-part `builtin.basic-parts/30` catalog, connector taxonomy, collision model, and derived Three.js geometry are implemented with versioned provenance; 76 definitions retain project-authored physical recipes and 30 are fully measured, while the render path comprises 60 parametric definitions and 46 exact LDraw roots or closures, including 16 render-only promotions. The historical `/26` catalog contained 98 parts, and `/27` contained 102. Individual geometry recipes carry SHA-256 content hashes and the truth snapshot pins their aggregate interpretation inputs. Synthetic benchmark examples remain an intent record.
- Real LDraw part geometry is bundled under the selected CC BY 4.0 option for 46 parts. Historical `/26` comprised 37 roots, 211 unique files, and 21 fully measured definitions; `/27` added fully measured `99563`, `73230`, `35464`, and `49307`, reaching 41 roots, 224 files, and 25 fully measured definitions; `/28` added exact suffixed `3245c` and `2453b`, reaching 43 roots, 228 files, and 27 fully measured definitions; `/29` added exact `10201` and `3245b`, reaching 45 roots, 237 files, and 29 fully measured definitions; `/30` promotes existing jumper `15573` to an exact fully measured definition, reaching 46 roots, 239 files, and 30 fully measured definitions. File-level attribution covers 235 direct CC BY 4.0 declarations plus `parts/2453b.dat`, `parts/30503.dat`, `parts/32064a.dat`, and `parts/3245c.dat`, whose CC BY 4.0 option is selected from dual declarations, across 34 named authors. All sixteen render-only promotions preserve their reviewed connector, allowance, and conservative collision declarations; a render mesh does not establish physical truth.
...
- The LDCad Shadow Library is CC BY-SA 4.0, and the owner directed on 2026-08-05 that licence must not block this private, noncommercial work, so its derived connector positions are admitted through `builtin.basic-parts/26`, `/27`, `/28`, `/29`, and `/30`, giving 22 exact current routes. Historical `/26` carried 13 exact routes; `/27` added four for `99563`, `73230`, `35464`, and `49307`; `/28` added exact suffixed `3245c` and `2453b`; `/29` added exact `10201` and `3245b`; `/30` adds exact `15573` with three underside seats and explicit shared half-capacity cells. Three things that decision did not waive are still true and still recorded: attribution travels with the derived data and is rendered into the notices from the catalog, ShareAlike — including the sui generis database-rights clause — would attach to that derived data on redistribution and a public release must license it share-alike or re-derive it independently, and training rights remain unheld. No shadow file is committed; what is admitted is derived positions.
