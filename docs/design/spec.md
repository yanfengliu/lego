...
The exact-five calibration foundation binds only steps/pages 90/79, 101/87, 346/213, 358/218, and 359/219 to a contract derived from all 359 prepared panels. Its optional high-RGBA snapshot guarantees only retained-byte integrity, not which PDF, panel preparation, served source, or execution produced those pixels. Its parser records a packet's claimed human review as an unverified external-review claim, and adjudication remains `needs-adjudication` for missing truth, drift, W mismatch, and exact W equality alike because no human-owned review issuer or execution-to-W provenance boundary exists. It cannot admit or launch the full source-parity probe.
