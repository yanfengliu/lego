...
The 14,172-row reproduction remains the retained historical `/15` long-browser denominator; the `/19` catalog repins its production compatibility boundary but no `/16`, `/17`, `/18`, or `/19` long rerun is claimed.
