...
- Step 33: playback fails `PART_STUD_BODY_COLLISION`; it is the first invalid step after 32 valid ones. Every colliding pair includes a black 15254 arch placed at step 30 or 32.
