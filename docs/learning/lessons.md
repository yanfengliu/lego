...
- A model's local part frames can be right while its world placements are mirrored; only a chiral part or a global fit tells them apart. ([evidence](lessons-evidence.md#local-frames-can-be-right-while-world-placements-are-mirrored))
