...
- Elongation and area do not separate a brick from an arrow, but how much of its own box it fills does. ([evidence](lessons-evidence.md#elongation-and-area-do-not-separate-a-brick-from-an-arrow-but-fill-does))
