...
- A classifier with fewer outcomes than the world answers what it cannot see with a confident positive; give "cannot tell" its own row. ([evidence](lessons-evidence.md#a-classifier-with-fewer-outcomes-than-the-world-reports-a-confident-positive))
