...
The separate tracked ledger/current-catalog identity check measured 19 of the immutable 121 required leaf design IDs under historical `/25` at `sha256:7859f65b300f4e8a2b6dae85cffedbcd71e5f54fcffd8f688089c3353c549f28`; current `/28` remains 24 at `sha256:1065c3a3d04787974aa43c8ede60c1937930884bdf297488d3731dc8c99ea591`: exact suffix admissions `3245c` and `2453b` do not normalize bare or cross-suffix IDs and therefore do not add the unresolved Builder `3245;M` or `2453;I` rows. That inventory intersection establishes neither a continuous printed-step prefix nor a build frontier; `11212` has no trusted printed-crop or placement authority, the stale step-39 pair-judged and step-101 unreviewed `32064` locators remain counterevidence only, and `33909` has no trusted printed identity, printed crop, placement, action-ledger, or frontier authority because its stale step-76 locator is internally inconsistent. All seven retained `78329` locators at steps 265, 268, 271, 274, 277, 282, and 336 are likewise stale and self-contradictory and grant no trusted printed identity, crop, placement, action-ledger, or frontier authority. Current semantic coverage `/4` is 588,467 bytes at `sha256:a12d5744f3f4417628e53227aaa4c35d9aee0eba5fdce7b865087e6f97dfbfad` and measures all 49 part-bearing rows / 320 pieces catalog-placeable while production identity and action consumers refuse it; the prior `/27` coverage report remains counterevidence. The exact suffix rows still lack trusted Builder physical frames. No printed identity, assignment, frame, placement, replay, action-ledger, source-execution, acceptance, or step-frontier authority follows; the action ledger remains through step 25, with the step-26 `28802` versus Builder `10201` contradiction unresolved.
