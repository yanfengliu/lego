...
from measured_part_plan_support import (
    BRICK_HEIGHT_LDU,
    BUILDER_80015_CONNECTIVITY,
    measured_part_plan as _plan,
)
...
ADMITTED_PART_PLANS: tuple[MeasuredPartPlan, ...] = (
    ...
    _plan("10201", "bracket", 4, 1, variant="rounded-corners", height_ldu=20, translation_ldu=(0, -10, 0),
        connector_source=LDCAD_SHADOW_CONNECTOR_SOURCE, catalog_id="builtin:bracket-1x2-1x4-rounded-corners",
        display_name="Bracket 1 x 2 - 1 x 4 with Rounded Corners", validated_connection_stud_profile="nominal-stud-tube/1", allow_ldcad_square_s6_clutches=True),
    _plan("3245b", "brick", 1, 2, variant="inside-axle-holder", height_ldu=48, orientation_id="upright-yaw-90",
